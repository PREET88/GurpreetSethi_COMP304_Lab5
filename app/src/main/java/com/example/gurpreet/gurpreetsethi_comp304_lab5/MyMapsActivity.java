...
public class MyMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (id.equals("Tim Hortons")) {
            ...
            restaurant = new LatLng(43.7211212, -79.2715432);
            mMap.addMarker(new MarkerOptions().position(restaurant).title(id));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(restaurant));

        }
        else if (id.equals("Burger king")){

            restaurant = new LatLng(43.7229996,-79.3007813);
            mMap.addMarker(new MarkerOptions().position(restaurant).title(id));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(restaurant));
        }
            ...
            restaurant = new LatLng(43.642567, -79.387054);
            mMap.addMarker(new MarkerOptions().position(restaurant).title(id));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(restaurant));
            ...
            restaurant = new LatLng(43.623409, -79.368683);
            mMap.addMarker(new MarkerOptions().position(restaurant).title(id));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(restaurant));
